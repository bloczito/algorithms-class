...
{
//    if(!ptr || !cur_size) return false;
//
//    if(!ptr->left) {
//        replace_child(ptr, ptr->right);
//    } else if (!ptr->right) {
//        replace_child(ptr, ptr->left);
//    } else {
//        Node * succ = ptr->right;
//        while (succ->left)
//            succ = succ->left;
...
//        }
//        Node* left = ptr->left;
//        replace_child(ptr, succ);
//        cout << "CHECK : left " << ptr->left << " right " << ptr->right << endl;
//
//        succ->left = left;
...
template<class T>
void BST<T>::replace_child(BST::Node * prev, BST::Node * next) {
